...
public final class FragmentABinding implements ViewBinding {
  ...
  @NonNull
  public final TextView fragA;

  private FragmentABinding(@NonNull FrameLayout rootView, @NonNull TextView fragA) {
  ...
  public static FragmentABinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fragA;
      TextView fragA = ViewBindings.findChildViewById(rootView, id);
      if (fragA == null) {
        break missingId;
      }

      return new FragmentABinding((FrameLayout) rootView, fragA);
    }
